...
@section('content')
    <div class="confirm-form__content">
        <div class="confirm-form__content-wrapper">
            ...
            <form action="{{ route('thanks') }}" method="POST" class="confirm-form">
                @csrf
                <table class="confirm-form__table">
                    <tr class="confirm-form__table-row">
                        <th class="confirm-form__table-title">お名前</th>
                        <td class="confirm-form__table-data">{{ $contact['last_name'] }}&emsp;{{ $contact['first_name'] }}</td>
                    </tr>
                    <tr class="confirm-form__table-row">
                        <th class="confirm-form__table-title">性別</th>
                        <td class="confirm-form__table-data">
                ...
                <div class="confirm-form__button">
                    ...
                    <a href="{{ route('index') }}" class="confirm-form__button-edit">修正</a>
                </div>
            </form>
        </div>
    </div>
